...
public class LevelGenerator2 {
     ...
     */
    public LevelGenerator2(GameController.PUZZLE_SIZES size) {
        this.size = size;
    }
    ...
    private void showLevelFeatures(
        ...
        System.out.println("");
        System.out.println("Level's kind: Absolutely random adjacency");
    ...
    public ArrayList<String [][]> getGeneratedLevel(boolean showFeatures) {
        ...
        } while(!SearchAlgorithms2.isConnectedPuzzle(puzzle));

        // Show the computes
        if (showFeatures) {
            this.showLevelFeatures(size[0], size[1], colors, distribution, puzzleArray, puzzle, numRecursiveCalls);
        }
    ...
    private Distribution getPuzzleDistribution() {
        ...
        switch (this.size) {
            ...
            case S33:
                ...
                // Only towers
                distributions.add(new Distribution(0, 0, 0));
                distributions.add(new Distribution(15, 0, 0));
                distributions.add(new Distribution(25, 0, 0));
                break;
            ...
            case S43:
                ...
                // Only towers
                distributions.add(new Distribution(0, 0, 0));
                distributions.add(new Distribution(10, 0, 0));
                distributions.add(new Distribution(20, 0, 0));
                distributions.add(new Distribution(30, 0, 0));
            ...
            case S54:
                ...
                distributions.add(new Distribution(10, 15, 10));
                ...
                distributions.add(new Distribution(20, 0, 0));
                distributions.add(new Distribution(30, 0, 0));
                distributions.add(new Distribution(40, 0, 0));
                break;
            ...
            case S65:
                distributions.add(new Distribution(0, 0, 0));
                distributions.add(new Distribution(5, 0, 0));
                distributions.add(new Distribution(10, 0, 0));
                distributions.add(new Distribution(20, 0, 0));
                distributions.add(new Distribution(30, 0, 0));
                distributions.add(new Distribution(40, 0, 0));
                distributions.add(new Distribution(50, 0, 0));
                ...
                distributions.add(new Distribution(5, 10, 10));
                distributions.add(new Distribution(5, 10, 75));
                break;

            default:

                // Only towers
                distributions.add(new Distribution(0, 0, 40));
                distributions.add(new Distribution(5, 5, 40));
                distributions.add(new Distribution(10, 5, 40));

                // Not only towers
                distributions.add(new Distribution(0, 5, 20));
                distributions.add(new Distribution(10, 5, 20));
                distributions.add(new Distribution(60, 0, 40));
                distributions.add(new Distribution(5, 5, 70));
                distributions.add(new Distribution(5, 5, 80));

                // TODO testing how these distributions work
                distributions.add(new Distribution(20, 5, 40));
                /*distributions.add(new Distribution(30, 5, 40));
                distributions.add(new Distribution(40, 5, 40));
                distributions.add(new Distribution(50, 0, 40));
                distributions.add(new Distribution(20, 5, 25));
                distributions.add(new Distribution(30, 5, 30));
                distributions.add(new Distribution(40, 0, 35));*/
